  ...
  const {store, dispatch} =useGlobalReducer()
  	...
  	return (
			<nav className="navbar navbar-light bg-light">
				...
				{store.navesFavoritas.map((nave, index)=><li className="d-flex justify-content-between" key={'nave-${index}'}>
				...
				{store.personajesFavoritos.map((personaje, index)=><li className="d-flex justify-content-between" key={'personaje-${index}'}>
				...
				{store.planetasFavoritos.map((planeta, index)=><li className="d-flex justify-content-between" key={'planeta-${index}'}>
